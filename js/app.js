...
// numCols = 5,
// col * 101, row * 83
// player width 101,height 171
let maxSpeed = 400, canvasHeight = 606, canvasWidth = 505, numRows = 6, numCols = 5, columnWidth = 101, rowHeight = 83, playerXStart = 202.5, playerYStart = 383;
...
class Enemy {
    ...
    checkCollision() {
        const playerWidth = 50, playerHeight = 60, enemyWidth = 60, enemyHeight = 50;
